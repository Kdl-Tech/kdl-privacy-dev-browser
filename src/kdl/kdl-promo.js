...
(function () {
  ...
  // Exposé pour les panneaux qui injectent l'encart après coup (contenu ajouté
  // dynamiquement dans le DOM, hors du passage DOMContentLoaded initial).
  window.KDLPromo = { monter: monter };
